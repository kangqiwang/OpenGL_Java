...
//			T.LookAt(0, 0, 0, 0, 0, -100, 0, 1, 0);  	//Default					
		...
		public void init(GLAutoDrawable drawable) {
			...
			// Set Sphere material
			//colour Ruby
		    Vec4 materialAmbient1 = new Vec4(0.1745f, 0.01175f, 0.01175f, 0.55f);
		    Vec4 materialDiffuse1 = new Vec4(0.61424f, 0.04136f, 0.04136f, 0.55f);
		    Vec4 materialSpecular1 = new Vec4(0.727811f, 0.626959f, 0.626959f, 0.55f);
		    ...
		    SObject cylinder = new SCylinder(1,100,100);
			idPoint = 1;
			idBuffer = 1;
			idElement = 1;
		    ...
		    Vec4 ambientProduct1 = lightAmbient.times(materialAmbient2);
		    ambient2 = ambientProduct1.getVector();
		    Vec4 diffuseProduct1 = lightDiffuse.times(materialDiffuse2);
		    diffuse2 = diffuseProduct1.getVector();
		    Vec4 specularProduct1 = lightSpecular.times(materialSpecular2);
		    specular2 = specularProduct1.getVector();
